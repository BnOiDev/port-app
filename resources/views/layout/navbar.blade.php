        ...
        <div class="flex -mx-4 items-center justify-between relative">
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="w-full flex items-center py-2">
                    ...
                    <span class="text-xl xl:text-sm font-bold text-[#fff] dark:text-primary p-2">Almeida</span>
                </a>
            </div>
            <div class="flex px-4 justify-end items-center w-full">
                <div>
                    ...
                    <nav :class="!navbarOpen && 'hidden'" id="navbarCollapse"
                        class="absolute right-0 top-full bg-white py-5 px-6 z-50 shadow rounded-lg w-full bg-white-900 dark:text-gray-300 lg:px-0 lg:max-w-full lg:w-full lg:right-4 lg:block lg:static lg:shadow-none">
